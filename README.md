...
the function is used in the begining when the program start, put "鏂板寳銇ㄣ亞銇靛簵(鑷鐢�)" in oled.

`font.h` and `font.c` are about word mold of **ASCII** and word mold of **鏂板寳銇ㄣ亞銇靛簵(鑷鐢�)**
